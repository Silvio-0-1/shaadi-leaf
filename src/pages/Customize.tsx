      ...
      {isMobile ? (
              ...
              {user && (
                ...
                >
                  {saving ? (
                    ...
                    <><Save className="h-4 w-4 mr-2" />{editId ? 'Update' : 'Save'}</>
                  )}
                </Button>
              )}
            </div>
        ...
        <div className="flex-1 overflow-hidden">
          <div className="h-full flex">
            ...
            <aside className="w-80 border-r bg-card/30 backdrop-blur-sm overflow-auto">
            ...
            <aside className="w-80 border-l bg-card/30 backdrop-blur-sm overflow-auto">
