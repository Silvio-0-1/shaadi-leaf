          ...
          <>
            {resizeHandles.map((handle) => (
              <div
                ...
                className={`absolute w-4 h-4 bg-white border-2 border-primary rounded-full shadow-lg opacity-90 hover:opacity-100 hover:scale-110 transition-all duration-150 ${handle.position}`}
